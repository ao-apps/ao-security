...
COMMENT ON FUNCTION "com.aoapps.security"."SmallIdentifier.valueOf" (character(11)) IS
'Matches method com.aoapps.security.SmallIdentifier.valueOf
Matches method com.aoapps.security.SmallIdentifier.<init>(String)';
