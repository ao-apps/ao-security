...
public final class HashedKey implements Comparable<HashedKey>, Serializable {
  ...
  public enum Algorithm {
    ...
    /**
     * Generates a random plaintext key of the given number of bytes using the provided {@link Random} source.
     */
     ...
     * @param  <Ex>  An arbitrary exception type that may be thrown
     */
    // Matches src/main/sql/com/aoapps/security/HashedKey.Algorithm.validateHash-function.sql
   ...
   */
  // Matches src/main/sql/com/aoapps/security/HashedKey.valueOf-function.sql
   ...
   * @param  <Ex>  An arbitrary exception type that may be thrown
   */
  // Matches src/main/sql/com/aoapps/security/HashedKey.validate-function.sql
   ...
   *              needed, pass a clone to this method.
   *
   * @see  Algorithm#validateKey(java.util.function.Function, com.aoapps.security.Key)
   */
