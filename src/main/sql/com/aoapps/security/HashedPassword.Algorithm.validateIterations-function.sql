...
COMMENT ON FUNCTION "com.aoapps.security"."HashedPassword.Algorithm.validateIterations" (text, integer) IS
'Matches method com.aoapps.security.HashedPassword.Algorithm.validateIterations';
